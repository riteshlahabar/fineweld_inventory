$(function() {
    ...
    */
    function loadDatatables(){
        ...
        var table = tableId.DataTable({
            ...
            method:'get',
            ajax: {
                    url: baseURL+'/partner/settlement/datatable-list',
                    data:{
                            user_id : $('#user_id').val(),
            ...
            columns: [
                ...
                {data: 'settlement_code', name: 'settlement_code'},
    ...
    */
    ...
    $(document).on("change", '#partner_id, #user_id, input[name="from_date"], input[name="to_date"]', function function_name(e) {
        loadDatatables();
    });
