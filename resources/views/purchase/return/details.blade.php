@extends('layouts.app')
@section('title', __('purchase.return.print'))
                    ...
                    <div class="card-body">
                        <div class="toolbar hidden-print">
                                <div class="text-end">
                                    ...
                                    <a href="{{ route('purchase.return.edit', ['id' => $return->id]) }}" class="btn btn-outline-primary"><i class="bx bx-edit"></i>{{ __('app.edit') }}</a>
                                    @endcan
                                    <a class="btn btn-outline-dark px-4 notify-through-email" data-model="purchase/return" data-id="{{$return->id}}" role="button">
                                    </i><i class="bx bx-envelope"></i>{{ __('app.email') }}</a>

                                    <a class="btn btn-outline-info px-4 notify-through-sms" data-model="purchase/return" data-id="{{$return->id}}" role="button">
                                    </i><i class="bx bx-envelope"></i>{{ __('message.sms') }}</a>

                                    <a href="{{ route('purchase.return.print', ['id' => $return->id]) }}" target="_blank" class="btn btn-outline-secondary px-4"><i class="bx bx-printer mr-1"></i>{{ __("app.print") }}</a>

                                    <a href="{{ route('purchase.return.pdf', ['id' => $return->id]) }}" target="_blank" class="btn btn-outline-danger px-4"><i class="bx bxs-file-pdf mr-1"></i>{{ __("app.pdf") }}</a>
                                    ...
                                    <main>
                                        <div class="row contacts">
                                            <div class="col invoice-to">
                                                <div class="text-gray-light fw-bold text-uppercase">{{ __('purchase.return_to') }}:</div>
                                                <h2 class="to">{{ $party->company_name }}</h2>
                                                <div class="address">{{ $return->party->billing_address }}</div>
                                            </div>
                                            ...
                                            <div class="col invoice-details">
                                                ...
                                                <div class="date">{{ __('purchase.purchase_bill_number') }}: {{ $return->reference_no  }}</div>
                                                @endif
