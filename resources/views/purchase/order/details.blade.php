@extends('layouts.app')
@section('title', __('purchase.order.print'))
                    ...
                    <div class="card-body">
                        <div class="toolbar hidden-print">
                                <div class="text-end">
                                    ...
                                    <a href="{{ route('purchase.order.pdf', ['id' => $order->id]) }}" target="_blank" class="btn btn-outline-danger px-4"><i class="bx bxs-file-pdf mr-1"></i>{{ __("app.pdf") }}</a>
                                    ...
                                    <main>
                                        <div class="row contacts">
                                            <div class="col invoice-to">
                                                <div class="text-gray-light fw-bold text-uppercase">{{ __('app.order_to') }}:</div>
                                            ...
                                            <div class="col invoice-details">
                                                <h1 class="invoice-id">{{ __('purchase.order.number') }} #{{ $order->order_code }}</h1>
                                        ...
                                        <table id="printInvoice">
                                            ...
                                            <tfoot>
                                                ...
                                                $bottomColumnsCount = 5 + $totalBatchTrackingRowCount + app('company')['show_hsn'] + app('company')['show_discount'] + app('company')['show_mrp'] - (app('company')['tax_type'] == 'no-tax' ? 1 : 0);
                                                @endphp
                                                <tr>
                                                    <td colspan="{{$bottomColumnsCount}}" class="tfoot-first-td">{{ __('app.subtotal') }}</td>
                                                    <td>{{ $formatNumber->formatWithPrecision($subtotal) }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="{{$bottomColumnsCount}}" class="tfoot-first-td">{{ __('app.discount') }}(-)</td>
                                                    <td>{{ $formatNumber->formatWithPrecision($discount) }}</td>
                                                </tr>
                                                <tr class="{{ (app('company')['tax_type'] == 'no-tax') ? 'd-none':'' }}">
                                                    <td colspan="{{$bottomColumnsCount}}" class="tfoot-first-td">{{ __('tax.tax') }}</td>
                                                    <td>{{ $formatNumber->formatWithPrecision($taxAmount) }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="{{$bottomColumnsCount}}" class="tfoot-first-td">{{ __('app.round_off') }}</td>
                                                ...
                                                @if(app('company')['is_enable_secondary_currency'])
                                                    <tr>
                                                        <td colspan="{{ $bottomColumnsCount }}" class="tfoot-first-td">{{ __('currency.converted_to').'-'.$order->currency->code }}</td>
