                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select party-ajax" data-party-type='customer' data-placeholder="Select Customer" id="party_id" name="party_id">
                                                        <option value="{{ $quotation->party->id }}">{{ $party->company_name }}</option>
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <x-input type="text" additionalClasses="datepicker-edit" name="quotation_date" :required="true" value="{{ $quotation->formatted_quotation_date }}"/>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <x-dropdown-general optionNaming="quotationStatus" selected="{{ $quotation->quotation_status }}" dropdownName='quotation_status'/>
                                            </div>
                                            @if(app('company')['is_enable_secondary_currency'])
                                            <div class="col-md-4">
                                                <x-label for="sale_price" name="{{ __('currency.exchange_rate') }}" />
                                                <div class="input-group mb-3">
                                                    <x-dropdown-currency selected="{{ $quotation->currency_id }}" name='invoice_currency_id'/>
                                                    <x-input type="text" name="exchange_rate" :required="false" additionalClasses='cu_numeric' value="{{ $quotation->exchange_rate }}"/>
                                                </div>
                                            </div>
                                            @endif
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <x-textarea name='note' value='{{ $quotation->note }}'/>
                                            </div>
                                                ...
                                                <table class="table mb-0 table-striped">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <x-input type="text" additionalClasses="text-end paid_amount" readonly=true :required="false" placeholder="Paid Amount" value="{{ $formatNumber->formatWithPrecision($quotation->paid_amount, comma:false) }}"/>
                                                        </td>
                                                      </tr>
                                                      <tr>
