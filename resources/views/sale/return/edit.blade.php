@extends('layouts.app')
@section('title', __('sale.return.return'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="g-3 needs-validation" id="invoiceForm" action="{{ ($return->operation == 'convert') ?  route('sale.to.sale.return.save') : route('sale.return.update') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf

                        {{-- Holds PUT method if Edit operation, else holds POST if Sale converting to Sale Return --}}
                        ...
                        {{-- Holds "update" method if Edit operation, else holds "convert" if Sale Order converting to Sale --}}
                            ...
                            <div class="col-12 col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            ...
                                            <div class="col-md-4">
                                                <x-label for="sale_code" name="{{ __('sale.return.code') }}" />
                                                <div class="input-group mb-3">
                                            ...
                                            <div class="col-md-4">
                                                <x-label for="reference_no" name="{{ __('sale.sale_invoice_number') }}" />
...
<script src="{{ versionedAsset('custom/js/sale/sale-return.js') }}"></script>
