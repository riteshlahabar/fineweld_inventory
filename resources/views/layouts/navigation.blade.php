				...
				<li>
					...
					<ul>
						...
						<li class="{{ request()->is(['party/customer/*', 'party/payment/customer/*'])? 'mm-active' : '' }}">
						    <a href="{{ route('party.list', ['partyType' => 'customer']) }}"><i class='bx bx-radio-circle'></i>{{ __('Vendors') }}</a>
						</li>
						@endcan
...
@endcan
        ...
        <li class="{{ request()->is('tickets/list') ? 'mm-active' : '' }}">
            <a href="{{ route('tickets.list') }}">
                <i class='bx bx-radio-circle'></i> All Tickets
            </a>
        </li>
        @endcan
        ...
        {{-- Raise a Ticket --}}
        @can('ticket.create')
        <li class="{{ request()->is('tickets/create') ? 'mm-active' : '' }}">
            <a href="{{ route('tickets.create') }}">
                <i class='bx bx-radio-circle'></i> Raise a Ticket
            </a>
        </li>
        @endcan
        ...
        {{-- Assign Technicians --}}
        @can('ticket.assign')
        <li class="{{ request()->is('tickets/assign') ? 'mm-active' : '' }}">
            <a href="{{ route('tickets.assign') }}">
                <i class='bx bx-radio-circle'></i> Assign Technicians
            </a>
        </li>
        @endcan
        ...
        {{-- Live Tracking --}}
        @can('ticket.track')
        <li class="{{ request()->is('tickets/track') ? 'mm-active' : '' }}">
            <a href="{{ route('tickets.track') }}">
                <i class='bx bx-radio-circle'></i> Live Tracking
            </a>
        </li>
        @endcan
        ...
        {{-- Ticket Status --}}
        @can('ticket.status')
        <li class="{{ request()->is('tickets/status') ? 'mm-active' : '' }}">
            <a href="{{ route('tickets.status') }}">
                <i class='bx bx-radio-circle'></i> Ticket Status
            </a>
        </li>
        @endcan
        ...
        {{-- Feedback --}}
        @can('ticket.feedback')
        <li class="{{ request()->is('tickets/feedback') ? 'mm-active' : '' }}">
            <a href="{{ route('tickets.feedback') }}">
                <i class='bx bx-radio-circle'></i> Feedback
            </a>
        </li>
        @endcan
        ...
        {{-- Reports --}}
        @can('ticket.reports')
        <li class="{{ request()->is('tickets/reports') ? 'mm-active' : '' }}">
            <a href="{{ route('tickets.reports') }}">
...
{{-- ===========================================
     ...
     =========================================== --}}
                ...
                <li class="menu-label">ADD-ONS</li>
                <li>
					<a href="javascript:;" class="has-arrow">
						<div class="parent-icon">
                            <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24" >
                                <!--Boxicons v3.0 https://boxicons.com | License  https://docs.boxicons.com/free-->
                                <path d="m8.76,7.95c-.19.19-.19.51,0,.71l.1.1c.76.76,2.07.76,2.83,0l3.04-3.04.71.71-.9.9,5.78,5.78c2.29-2.36,2.27-6.01-.07-8.35,0,0,0,0,0,0-2.16-2.15-5.42-2.31-7.77-.54l-3.71,3.74Z"></path><path d="m9.59,15.81l.71-.71,4,4,1.19-1.19-4.01-4.01.71-.71,4.01,4.01,1.19-1.19-4.01-4.01.71-.71,4.01,4.01,1.51-1.5-5.79-5.78-1.43,1.43c-.57.57-1.32.88-2.12.88s-1.55-.31-2.12-.88l-.1-.1c-.58-.58-.58-1.53,0-2.12l3.21-3.24c-2.33-1.55-5.42-1.31-7.5.75-2.36,2.37-2.36,6.07,0,8.43l7.53,7.52c.19.19.45.29.71.29s.51-.1.71-.29l.89-.89-4-4Z"></path>
                            </svg>
						</div>
						<div class="menu-title">{{
						__('partnership::partner.partners') }} &nbsp;<span class="badge bg-success">New</span></div>
					</a>
					<ul>
                        @can('partner.create')
						<li class="{{ request()->is('partner/create') ? 'mm-active' : '' }}">
                            <a href="{{ route('partnership.partner.create') }}"><i class='bx bx-radio-circle'></i>{{ __('partnership::partner.add_partner') }}</a>
                        </li>
						@endcan
						@can('partner.view')
						<li class="{{ request()->is('partner/list', 'partner/edit*') ? 'mm-active' : '' }}">
                            <a href="{{ route('partnership.partner.list') }}"><i class='bx bx-radio-circle'></i>{{ __('partnership::partner.partner_list') }}</a>
						</li>
						@endcan
                        @can('partner.contract.view')
						<li class="{{ request()->is('partner/contract/*') ? 'mm-active' : '' }}">
                            <a href="{{ route('partnership.contract.list') }}"><i class='bx bx-radio-circle'></i>{{ __('partnership::partner.contract_list') }}</a>
						</li>
						@endcan
                        @can('partner.party-payment.allocation.view')
						<li class="{{ request()->is('partner/party-*/allocation') ? 'mm-active' : '' }}">
                            <a href="{{ route('partnership.partner.party-payment.list') }}"><i class='bx bx-radio-circle'></i>{{ __('partnership::partner.party_allocation') }}</a>
						</li>
						@endcan
                        @can('partner.settlement.view')
                        <li class="{{ request()->is('partner/settlement/*') ? 'mm-active' : '' }}">
                            <a href="{{ route('partnership.partner.settlement.list') }}"><i class='bx bx-radio-circle'></i>{{ __('partnership::partner.settlement_list') }}</a>
                        </li>
                        @endcan
                        @canany(['partner.report.*'])
						<li class="{{ request()->is('partner/report/*') ? 'mm-active' : '' }}">
                            <a href="{{ route('partnership.report.contract') }}"><i class='bx bx-radio-circle'></i>{{ __('app.reports') }}</a>
						</li>
						@endcan
                ...
                <li class="{{ request()->is('modules*') ? 'mm-active' : '' }}">
					<a href="{{ route('admin.modules.install-partnership') }}">
						<div class="parent-icon"><i class='bx bx-plug'></i>
						</div>
						<div class="menu-title">{{ __('app.modules') }} &nbsp;<span class="badge bg-success">New</span></div>
					</a>
				</li>
                @endif
