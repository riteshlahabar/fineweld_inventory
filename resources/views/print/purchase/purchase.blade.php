        ...
        <table class="table-bordered custom-table table-compact" id="item-table">
            ...
            <tfoot>
                ...
                @php
                    ...
                    $noteRowSpan = 4 - ((app('company')['tax_type'] =='no-tax') ? 1 : 0) + ($purchase->shipping_charge>0 ? 1 : 0);

                    $amountInWordsRowSpan = 3 + app('company')['show_mrp'] + app('company')['show_party_due_payment'] + app('company')['is_enable_secondary_currency'];
                @endphp
                <tr>
                    <td colspan="{{ $noteColumns }}" rowspan="{{$noteRowSpan}}" class="tfoot-first-td">
                ...
                <tr>
                    ...
                    <td colspan="1" class="text-end">{{ $formatNumber->formatWithPrecision($purchase->shipping_charge) }}</td>
                </tr>
                @endif
                <tr>
