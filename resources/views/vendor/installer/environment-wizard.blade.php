        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    <label for="app_name">
                        {{ trans('installer_messages.environment.wizard.form.app_name_label') }} <span class="text-danger text-sm">(Required)</span>
                    </label>
                    <input type="text" name="app_name" id="app_name" onkeydown="avoidSpaceInInputBox(event)" value="" placeholder="Space is not allowed to add App Name" />
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    <label for="app_url">
                        {{ trans('installer_messages.environment.wizard.form.app_url_label') }} <span class="text-danger text-sm">(Required)</span>
                    </label>
                ...
                <div class="form-group {{ $errors->has('envato_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="envato_username" id="envato_username" value="*******************" readonly />
                 ...
                 <!-- Add User Email address to install application -->
                 <div class="form-group {{ $errors->has('user_email') ? ' has-error ' : '' }}">
                    <label for="user_email">
                        User Email Address <span class="text-danger text-sm">(Required)</span>
                    </label>
                 ...
                 <div class="form-group {{ $errors->has('envato_purchase_code') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="envato_purchase_code" id="envato_purchase_code" value="****************" readonly  />
...
@section('scripts')
    <script type="text/javascript">
        ...
        function avoidSpaceInInputBox(event) {
            if (event.keyCode === 32) {
                // Prevent default behavior (space insertion)
