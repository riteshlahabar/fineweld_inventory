...
@section('title', __('partnership::partner.profit_report_item_wise'))
...
<div class="tab-pane fade show active" id="partyOpeningBalanceTab" role="tabpanel">
    ...
    <div class="row g-3">
        <form class="row g-3 needs-validation" id="reportForm" action="{{ route('partnership.report.profit.item.wise.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div>
                                                <div class="form-check mt-2">
                                                    <input class="form-check-input" type="checkbox" id="show_detailed" name="show_detailed" value="1" >
                                                    <label class="form-check-label" for="show_detailed">{{ __('partnership::partner.detailed_partner_item_profit') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                </div>
                        ...
                        <div class="col-12 col-lg-12 item-wise-table">
                            <div class="card">
                        ...
                        <div class="col-12 col-lg-12 item-wise-table-detailed d-none">
                            <div class="card">
                                <div class="card-header px-4 py-3">
                                    <div class="row">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6 text-end">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><button type='button' class="dropdown-item" id="generate_excel2"><i class="bx bx-spreadsheet mr-1"></i>{{ __('app.excel') }}</button></li>
                                                    <li><button type='button' class="dropdown-item" id="generate_pdf2"><i class="bx bx-file mr-1"></i>{{ __('app.pdf') }}</button></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body p-4 row g-3">
                                        <div class="col-md-12 table-responsive">
                                            <table class="table table-bordered " id="recordsTable2">
                                                <thead>
                                                    <tr class="text-uppercase">
                                                        <th>#</th>
                                                        <th>{{ __('app.date') }}</th>
...
<script src="{{ versionedAsset('custom/js/modules/partnership/reports/partner-profit-item-wise.js') }}"></script>
@endpush
