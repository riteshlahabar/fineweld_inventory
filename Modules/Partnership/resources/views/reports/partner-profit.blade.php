...
@section('title', __('partnership::partner.profit_report'))
...
<div class="tab-pane fade show active" id="partyOpeningBalanceTab" role="tabpanel">
    ...
    <div class="row g-3">
        <form class="row g-3 needs-validation" id="reportForm" action="{{ route('partnership.report.profit.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
...
<script src="{{ versionedAsset('custom/js/modules/partnership/reports/partner-profit.js') }}"></script>
@endpush
