@extends('layouts.app')
@section('title', __('partnership::contract.list'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                    ...
                    <div class="card-header px-4 py-3 d-flex justify-content-between">
                        ...
                        <div>
                            <h5 class="mb-0 text-uppercase">{{ __('partnership::contract.list') }}</h5>
                        </div>

                        @can('partner.contract.create')
                        <!-- Button pushed to the right side -->
                        <x-anchor-tag href="{{ route('partnership.contract.create') }}" text="{{ __('partnership::contract.create') }}" class="btn btn-primary px-5" />
                        @endcan
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                        ...
                        <form class="row g-3 needs-validation" id="datatableForm" action="{{ route('partnership.contract.delete') }}" enctype="multipart/form-data">
                            {{-- CSRF Protection --}}
                            @csrf
                            @method('POST')
...
<script src="{{ versionedAsset('custom/js/modules/partnership/contract/contract-list.js') }}"></script>
@endsection
