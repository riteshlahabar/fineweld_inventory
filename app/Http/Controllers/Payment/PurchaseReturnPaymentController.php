...
class PurchaseReturnPaymentController extends Controller
{
     ...
     *
     * */
    public function getPurchaseReturnPaymentHistory($id): JsonResponse
    {

        $data = $this->getPurchaseReturnPaymentHistoryData($id);
     ...
     */
    public function printPurchaseReturnPayment($id, $isPdf = false): View
    {
        $payment = PaymentTransaction::with('paymentType')->find($id);

        $purchaseId = $payment->transaction_id;

        $model = PurchaseReturn::with('party')->find($purchaseId);
     ...
     * */
    public function pdfPurchaseReturnPayment($id)
    {
        $html = $this->printPurchaseReturnPayment($id, isPdf: true);
    ...
    public function getPurchaseReturnPaymentHistoryData($id)
    {
        $model = PurchaseReturn::with('party', 'paymentTransaction.paymentType')->find($id);
    ...
    public function getPurchaseReturnPayment($id): JsonResponse
    {
    ...
    public function deletePurchaseReturnPayment($paymentId): JsonResponse
    {
        try {
            DB::beginTransaction();
            ...
            return response()->json([
                ...
                'data' => $this->getPurchaseReturnPaymentHistoryData($purchase->id),
            ]);
    ...
    public function storePurchaseReturnPayment(Request $request)
    {
        try {
            DB::beginTransaction();
            ...
            $purchase = PurchaseReturn::find($invoiceId);
     ...
     * Datatabale
     * */
    public function datatablePurchaseReturnPayment(Request $request)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('party_name', function ($row) {
                return $row->transaction->party->company_name.' '.$row->transaction;
            })
