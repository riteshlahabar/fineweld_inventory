...
class OrderController extends Controller
{
    ...
    public function getOrderRecords(Request $request): JsonResponse
    {
        $preparedData = [];
     ...
     * */
    public function getOrderRecordsForReport(OrderReportRequest $request): JsonResponse
    {
        ...
        foreach ($preparedData as $order) {
            $recordsArray[] = [
                ...
                'customer_name' => $order->party->company_name.' '.$order,
     ...
     * */
    public function getOrderPaymentRecordsForReport(OrderPaymentReportRequest $request): JsonResponse
    {
        ...
        foreach ($preparedData as $payment) {
            $recordsArray[] = [
                ...
                'customer_name' => $payment->order->party->company_name.' '.$payment->order,
