...
use App\Http\Controllers\SupportPortal\SupportController;
...
Route::get('/vendor/register', [PartyController::class, 'publicForm'])
    ->name('vendor.public.form');

Route::post('/vendor/register', [PartyController::class, 'publicStore'])
    ->name('vendor.public.store');
...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'party'], function () {
        ...
        Route::get('/{partyType}/export', [PartyController::class, 'export']);
    });
    ...
    /**
 * Support Portal - Tickets Management
 */
